...
if __name__ == '__main__':
    ...
    f.post(text='Photo by <a href="%s?utm_source=%s&utm_medium=referral">%s</a> on <a href="https://unsplash.com/?utm_source=%s&utm_medium=referral">Unsplash</a>', image_path='../quotes_images/20190704225727.png')